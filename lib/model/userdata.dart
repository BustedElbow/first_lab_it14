...
class UserData {
  List<UserPost> userList = [
    UserPost(
      ...
      postImg: 'lib/images/products/image_4.jpg',
    ...
    UserPost(
      ...
      postImg: 'lib/images/products/image_5.jpg',
      numComments: '900 comments',
      numShare: '1k shares',
      isLiked: false,
    ),
    UserPost(
      userImg: 'lib/images/John_Doe.jpg',
      username: 'John Doe',
      time: '20 Nov at 9:30pm',
      postContent: 'Hi there!',
      postImg: 'lib/images/products/image_7.jpg',
